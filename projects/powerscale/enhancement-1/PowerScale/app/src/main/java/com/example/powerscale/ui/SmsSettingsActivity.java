...
/**
 * SmsSettingsActivity
 * This activity allows the user to enable/disable SMS notifications and save a phone number.
 *
...
public class SmsSettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Read current permission state once and use it to keep the toggle state consistent
        ...
        switchSmsEnabled.setOnCheckedChangeListener((buttonView, isChecked) -> {
            ...
            if (isChecked) {
                ...
                // Read permission state once before handling the toggle change
                boolean hasPermissionNow = hasSmsPermission();
        ...
        buttonSendTest.setOnClickListener(v -> {
            ...
            // Read permission state once before attempting to send the test message
            boolean hasPermissionNow = hasSmsPermission();
    ...
    private void sendTestSmsIfValid() {
        ...
        try {
            ...
            // Only show success if the send call completed without throwing an exception
